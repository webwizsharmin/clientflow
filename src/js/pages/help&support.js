export function renderHelpsPage() {
  ...
  content.innerHTML = `
    <div class="p-6">
  <h1 class="text-2xl font-bold text-slate-800 dark:text-slate-100 mb-2">Help & Support</h1>
  <p class="text-slate-500 dark:text-slate-400 mb-6">Find answers or reach out for help.</p>
